...
function Sidebar({ theme, setTheme, sidebarOpen, setSidebarOpen }) {
    ...
    function navLinkClass({ isActive }) {
        return isActive
            ? "side-bar-link side-bar-actif-link"
            : "side-bar-link ";
    }
        ...
        >
            <div className="side-bar-header">
                <div className="side-bar-header-logo">
                    <img src={logo} alt="NexTask" />
                    <button
                        className="side-bar-header-open-side-bar"
                ...
                <button
                    className="side-bar-header-close-side-bar"
                    onClick={isOpenToggle}
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="side-bar-footer">
                <button className="side-bar-mode-btn" onClick={themeToggle}>
                    {theme === "light" ? (
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="currentColor"
